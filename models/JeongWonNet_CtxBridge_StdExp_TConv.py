"""
JeongWonNet_CtxBridge_StdExp with Transposed Convolution Upsampling (Deterministic)

StdExp의 업샘플링을 F.interpolate(bilinear) 대신 ConvTranspose2d로 대체한 버전
...
class JeongWonNet_CtxBridge_StdExp_TConv(nn.Module):
    """
...
if __name__ == "__main__":
    model = JeongWonNet_CtxBridge_StdExp_TConv()
