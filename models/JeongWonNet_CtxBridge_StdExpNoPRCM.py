"""
JeongWonNet_CtxBridge_StdExp without PRCM in Deep Layers
...
깊은 레이어에서 PRCM 제거:
    - expansion-projection 자체가 채널 믹싱 제공
    - 깊은 레이어에서 PRCM의 global context가 덜 필요할 수 있음
    - 파라미터 절감
"""
import torch
...
class JeongWonNet_CtxBridge_StdExpNoPRCM(nn.Module):
    """
...
if __name__ == "__main__":
    model = JeongWonNet_CtxBridge_StdExpNoPRCM()
