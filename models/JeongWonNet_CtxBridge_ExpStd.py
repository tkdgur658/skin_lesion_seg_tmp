"""
JeongWonNet_CtxBridge_Exp with Std Conv in Deep Layers
...
StdExp의 반대 버전:
    - 얕은 레이어: 채널 수가 적어 expansion 비용이 낮음
    - 깊은 레이어: 채널 수가 많아 3x3이 더 효과적일 수 있음
"""
import torch
...
class JeongWonNet_CtxBridge_ExpStd(nn.Module):
    """
...
if __name__ == "__main__":
    model = JeongWonNet_CtxBridge_ExpStd()
