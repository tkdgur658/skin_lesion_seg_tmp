"""
JeongWonNet_CtxBridge_Std with Expansion in Deep Layers
...
깊은 레이어에서 3x3 대신 1x1 expansion-projection 사용:
    - 파라미터 효율적 (3x3: C²×9 vs 1x1 exp-proj: C×4C + 4C×C = 8C²)
    - 채널 믹싱 효과 유지
"""
import torch
...
class JeongWonNet_CtxBridge_PostStdExp_mod(nn.Module):
    """
...
if __name__ == "__main__":
    model = JeongWonNet_CtxBridge_PostStdExp_mod()
