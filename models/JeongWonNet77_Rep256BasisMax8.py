...
class JeongWonNet77_Rep256BasisMax8(nn.Module):
    """
    ...
    """
    def __init__(self, num_classes=1, input_channels=3, c_list=[8, 16, 32, 64, 128, 256], gt_ds=True):
        super().__init__()
        self.gt_ds = gt_ds
        ...
        def make_dw_block(in_ch, out_ch):
            ...
            layers.append(PRCM(out_ch, num_basis=max(8, in_ch//8)))
