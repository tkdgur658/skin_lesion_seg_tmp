"""
JeongWonNet_CtxBridge - Variant 2: 3x3 Standard Conv after PRCM

기존: pw_conv(1x1) → dw_conv(7x7) → prcm
변경: pw_conv(1x1) → dw_conv(7x7) → prcm → std_conv(3x3)

PRCM 이후 추가 공간 처리 및 채널 믹싱
"""
import torch
...
class DWBlock(nn.Module):
    """DWBlock with 3x3 standard conv after PRCM"""
...
class JeongWonNet_CtxBridge_StdPost(nn.Module):
    """
    Context Bridge with 3x3 Standard Conv after PRCM
...
if __name__ == "__main__":
    model = JeongWonNet_CtxBridge_StdPost()
