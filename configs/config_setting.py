...
class setting_config:
    ...
    elif network == 'UltraLight_VM_UNet':
        model_config = {
        'num_classes': 1,
        'input_channels': 3,
        'c_list': [8,16,24,32,48,64],
    ...
    elif network == 'MAResUNet':
        model_config = {
        'num_classes': 1,
        'num_channels': 3
    }
    elif network == 'MHA_UNet':
        model_config = {
        'num_classes': 1,
        'input_channels': 3,
